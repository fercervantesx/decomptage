...
extension Ghostty {
    ...
    static let userNotificationCategory = "com.fercervantes.decomptage.userNotification"

    // The user notification "Show" action
    static let userNotificationActionShow = "com.fercervantes.decomptage.userNotification.Show"
}
...
extension Notification.Name {
    ...
    static let ghosttyConfigDidChange = Notification.Name("com.fercervantes.decomptage.configDidChange")
    static let GhosttyConfigChangeKey = ghosttyConfigDidChange.rawValue

    /// Color change. Object is the surface changing.
    static let ghosttyColorDidChange = Notification.Name("com.fercervantes.decomptage.ghosttyColorDidChange")
    static let GhosttyColorChangeKey = ghosttyColorDidChange.rawValue

    /// Goto tab. Has tab index in the userinfo.
    static let ghosttyMoveTab = Notification.Name("com.fercervantes.decomptage.moveTab")
    static let GhosttyMoveTabKey = ghosttyMoveTab.rawValue

    /// Close tab
    static let ghosttyCloseTab = Notification.Name("com.fercervantes.decomptage.closeTab")

    /// Close other tabs
    static let ghosttyCloseOtherTabs = Notification.Name("com.fercervantes.decomptage.closeOtherTabs")

    /// Close tabs to the right of the focused tab
    static let ghosttyCloseTabsOnTheRight = Notification.Name("com.fercervantes.decomptage.closeTabsOnTheRight")

    /// Close window
    static let ghosttyCloseWindow = Notification.Name("com.fercervantes.decomptage.closeWindow")

    /// Resize the window to a default size.
    static let ghosttyResetWindowSize = Notification.Name("com.fercervantes.decomptage.resetWindowSize")

    /// Ring the bell
    static let ghosttyBellDidRing = Notification.Name("com.fercervantes.decomptage.ghosttyBellDidRing")

    /// Readonly mode changed
    static let ghosttyDidChangeReadonly = Notification.Name("com.fercervantes.decomptage.didChangeReadonly")
    static let ReadonlyKey = ghosttyDidChangeReadonly.rawValue + ".readonly"
    static let ghosttyCommandPaletteDidToggle = Notification.Name("com.fercervantes.decomptage.commandPaletteDidToggle")

    /// Toggle maximize of current window
    static let ghosttyMaximizeDidToggle = Notification.Name("com.fercervantes.decomptage.maximizeDidToggle")

    /// Notification sent when scrollbar updates
    static let ghosttyDidUpdateScrollbar = Notification.Name("com.fercervantes.decomptage.didUpdateScrollbar")
    static let ScrollbarKey = ghosttyDidUpdateScrollbar.rawValue + ".scrollbar"

    /// Focus the search field
    static let ghosttySearchFocus = Notification.Name("com.fercervantes.decomptage.searchFocus")
}
...
extension Ghostty.Notification {
    ...
    static let NewSurfaceConfigKey = "com.fercervantes.decomptage.newSurfaceConfig"

    /// Posted when a new split is requested. The sending object will be the surface that had focus. The
    /// userdata has one key "direction" with the direction to split to.
    static let ghosttyNewSplit = Notification.Name("com.fercervantes.decomptage.newSplit")

    /// Close the calling surface.
    static let ghosttyCloseSurface = Notification.Name("com.fercervantes.decomptage.closeSurface")

    /// Focus previous/next split. Has a SplitFocusDirection in the userinfo.
    static let ghosttyFocusSplit = Notification.Name("com.fercervantes.decomptage.focusSplit")
    static let SplitDirectionKey = ghosttyFocusSplit.rawValue

    /// Goto tab. Has tab index in the userinfo.
    static let ghosttyGotoTab = Notification.Name("com.fercervantes.decomptage.gotoTab")
    static let GotoTabKey = ghosttyGotoTab.rawValue

    /// New tab. Has base surface config requested in userinfo.
    static let ghosttyNewTab = Notification.Name("com.fercervantes.decomptage.newTab")

    /// New window. Has base surface config requested in userinfo.
    static let ghosttyNewWindow = Notification.Name("com.fercervantes.decomptage.newWindow")

    /// Present terminal. Bring the surface's window to focus without activating the app.
    static let ghosttyPresentTerminal = Notification.Name("com.fercervantes.decomptage.presentTerminal")

    /// Toggle fullscreen of current window
    static let ghosttyToggleFullscreen = Notification.Name("com.fercervantes.decomptage.toggleFullscreen")
    static let FullscreenModeKey = ghosttyToggleFullscreen.rawValue

    /// Notification sent to toggle split maximize/unmaximize.
    static let didToggleSplitZoom = Notification.Name("com.fercervantes.decomptage.didToggleSplitZoom")

    /// Notification
    static let didReceiveInitialWindowFrame = Notification.Name("com.fercervantes.decomptage.didReceiveInitialWindowFrame")
    static let FrameKey = "com.fercervantes.decomptage.frame"

    /// Notification to render the inspector for a surface
    static let inspectorNeedsDisplay = Notification.Name("com.fercervantes.decomptage.inspectorNeedsDisplay")

    /// Notification to show/hide the inspector
    static let didControlInspector = Notification.Name("com.fercervantes.decomptage.didControlInspector")

    static let confirmClipboard = Notification.Name("com.fercervantes.decomptage.confirmClipboard")
    ...
    static let didResizeSplit = Notification.Name("com.fercervantes.decomptage.didResizeSplit")
    ...
    static let didEqualizeSplits = Notification.Name("com.fercervantes.decomptage.didEqualizeSplits")

    /// Notification that renderer health changed
    static let didUpdateRendererHealth = Notification.Name("com.fercervantes.decomptage.didUpdateRendererHealth")

    /// Notifications related to key sequences
    static let didContinueKeySequence = Notification.Name("com.fercervantes.decomptage.didContinueKeySequence")
    static let didEndKeySequence = Notification.Name("com.fercervantes.decomptage.didEndKeySequence")
    static let KeySequenceKey = didContinueKeySequence.rawValue + ".key"

    /// Notifications related to key tables
    static let didChangeKeyTable = Notification.Name("com.fercervantes.decomptage.didChangeKeyTable")
