...
class DockTilePlugin: NSObject, NSDockTilePlugIn {
    ...
    #if DEBUG
    private let ghosttyUserDefaults = UserDefaults(suiteName: "com.fercervantes.decomptage.debug")
    #else
    private let ghosttyUserDefaults = UserDefaults(suiteName: "com.fercervantes.decomptage")
    #endif
